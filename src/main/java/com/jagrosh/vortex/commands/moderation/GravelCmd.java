...
public class GravelCmd extends ModCommand {
    ...
    protected void execute(CommandEvent event) {
        ...
        for (int i = 0; i < toGravel.size(); i++) {
            ...
            String[] messages = {" " + user + " was banished to the gravel pit", " " + user + " was graveled", " " + user + " was sent to find flint", " Added gravel to " + user, " " + user + " fell in a pit of gravel", " Successfully poured some gravel on " + user};
